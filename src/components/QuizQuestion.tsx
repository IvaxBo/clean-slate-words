    ...
    <div className="flex flex-col h-full">
      <div className="bg-secondary rounded-2xl p-6 mb-6 animate-fade-in">
        ...
        <div className="flex justify-center">
          <span className="inline-flex items-center px-3 py-1 bg-foreground text-background rounded-full text-sm font-semibold">
            🇩🇪 {language}
          </span>
        </div>
      </div>
      ...
      <div className="flex-1 space-y-3">
        {options.map((option, index) => (
          <Button
            ...
            className={cn(
              "justify-between animate-slide-up",
              hasAnswered && option === correctAnswer && "font-bold"
            )}
